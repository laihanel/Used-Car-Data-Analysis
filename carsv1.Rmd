...
Additionally, the team decided to build the Ridge regression model to deal with the issue of multicollinearity. 
...
print(rsq_lasso_cv)
```
It was observed that the lowest value of MSE on test for the computed lambda value is `r ssr_cv` and the R-squared value to be `r rsq_lasso_cv`
