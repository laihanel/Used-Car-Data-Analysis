...
## Lets check if the true mean of price for the two engine types is equal
```{r}
...
## Does the Color influnce the prices
```{r}
...
```
## Does the Body type influnce the Prices
```{r}
...
## Lets check the top 10 manufacturer by mean price
```{r}
...
## Does the interaction manufacturer affect the price
```{r}
