...
Data sample is large enough, but after deleting variable with large VIF engine `type`, the overall fitness dropped significantly. Thus PatternSix opted for biased estimation to solve multi-collinearity problem.
...
(adjr2 = 1 - (1 - R2(pls2, ncomp = min_comp)$val[2]) * (nrow(df_stdize) - 1) / (nrow(df_stdize) - min_comp - 1))
